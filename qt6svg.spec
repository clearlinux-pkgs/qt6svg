...
Source0  : https://download.qt.io/official_releases/qt/6.6/6.6.1/submodules/qtsvg-everywhere-src-6.6.1.tar.xz
...
%prep
%setup -q -n qtsvg-everywhere-src-6.6.1
cd %{_builddir}/qtsvg-everywhere-src-6.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703010017
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtSvg/6.6.1/QtSvg/private/qsvgfont_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qsvggraphics_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qsvghandler_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qsvgnode_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qsvgstructure_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qsvgstyle_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qsvgtinydocument_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qtsvgexports_p.h
/usr/include/QtSvg/6.6.1/QtSvg/private/qtsvgglobal_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6Svg.so.6.6.1
/V3/usr/lib64/libQt6SvgWidgets.so.6.6.1
...
/usr/lib64/libQt6Svg.so.6.6.1
/usr/lib64/libQt6SvgWidgets.so.6
/usr/lib64/libQt6SvgWidgets.so.6.6.1
